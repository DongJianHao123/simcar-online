...
export function createRobot(scene: THREE.Scene) {
    ...
    // Tread pattern: aligned with cross spokes, 4 evenly spaced
    ...
    wheelPositions.forEach(pos => {
        ...
        // Four tread stripes, aligned with cross spokes
        for (let i = 0; i < 4; i++) {
    ...
    armGroup.position.set(0, 0.6, 0.2);
